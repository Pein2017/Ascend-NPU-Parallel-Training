...
def train(
    ...
    :param verbose_print_interval: Frequency of logging within the epoch.
    ...
    for i, batch in enumerate(train_loader):
        ...
        if verbose and i % verbose_print_interval == 0 and gpu == 0:
...
def validate(
    ...
    :param verbose_print_interval: Frequency of printing detailed information.
    ...
    for i, batch in enumerate(val_loader):
        ...
        if verbose and i % verbose_print_interval == 0:
